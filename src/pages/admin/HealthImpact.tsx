    ...
    <div className="space-y-6 container mx-auto pb-10">
      ...
      >
        <div className="flex gap-5 items-center">
          ...
          <div>
            <h1 className="text-3xl font-black text-foreground tracking-tighter">Health & Climate Impact</h1>
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Zone Filter</span>
        ...
        {[
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-[10px] uppercase font-bold tracking-widest text-muted-foreground opacity-50">Pulse</span>
            </div>
            <h3 className="text-3xl font-black tracking-tighter text-foreground">{item.val}</h3>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-8 px-2 relative z-10">
            ...
            <div className="bg-primary/10 px-3 py-1 rounded-full border border-primary/20">
              <span className="text-[10px] font-black text-primary uppercase">Reliability: 94.2%</span>
            </div>
          </div>
        ...
        >
          <div className="flex items-center justify-between mb-6 px-1">
            ...
            <span className="text-[10px] uppercase font-black text-muted-foreground opacity-40 tracking-widest">Active Ward Scan</span>
          </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    <div key={r.label} className="text-center p-1.5 rounded-xl bg-card/40 border border-white/[0.03]">
                      ...
                      <p className="text-[10px] font-black" style={{ color: getRiskColor(r.val) }}>{r.val.toUpperCase()}</p>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="relative z-10 p-8 flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="flex-1 text-center md:text-left">
            <div className="flex items-center gap-3 justify-center md:justify-start mb-2">
              <h2 className="text-2xl font-black text-foreground tracking-tighter uppercase italic">HEATWAVE + AQI SYNERGY ALERT</h2>
          ...
          <div className="flex gap-4">
            <Button className="bg-orange-500 hover:bg-orange-600 text-white rounded-2xl px-8 font-black shadow-xl shadow-orange-500/40">Dispatch Health Units</Button>
            <Button variant="outline" className="border-orange-500/50 text-orange-400 rounded-2xl px-8 font-black backdrop-blur-md">Protocol View</Button>
          </div>
        </div>
      </motion.div>
    </div>
